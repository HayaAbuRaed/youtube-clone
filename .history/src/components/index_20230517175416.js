import {Home, HomeOutlined, Explore, ExploreOutlined,Subscriptions, SubscriptionsOutlined, Code, CodeOutlined, Gamep, GamepadOutlined} from '@mui/icons-material';
...
export const categories =[
    {
        txt: 'Code',
        icon: <Code/>,
        selectedIcon:  <CodeOutlined/>
    },
    {
        txt: 'Gaming',
        icon: <Gamepad/>,
        selectedIcon: <GamepadOutlined/>
    },
]